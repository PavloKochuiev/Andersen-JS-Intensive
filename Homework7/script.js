...
const previousOperandTextElement = document.querySelector('.calculator__display__previous');
const currentOperandTextElement = document.querySelector('.calculator__display__current');
